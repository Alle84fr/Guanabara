...
print(f"isalpha é {x.isalpha()}, todos caracteres devems ser letras")
print(f"isdecimal é {x.isdecimal()}, todos devem ser decimais (0-9)")
print(f"isupper é {x.isupper()}, todas letras devem ser maiúsculas")
print(f"islower é {x.islower()}, todas letras devems ser minúsculas")
print(f"isnumeric é {x.isnumeric()}, todos caracteres devems ser numéricos ( contandi dígitos especiais como VII)")
